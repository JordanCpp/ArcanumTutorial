...
namespace Arcanum
{
	...
	public:
		virtual ~ICanvas() {};
		virtual void Draw(ITexture* texture, const Point& dstPos, const Point& dstSize, const Point& srcPos, const Point& srcSize) = 0;
		virtual void Draw(ITexture* texture, const Point& dstPos) = 0;
